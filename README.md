...
By [Mike Wolf](https://github.com/EmbeddedMike), for use on [glitch](https://glitch.com). github repository for the adapted version is [Being Updated--this is not currrent ](https://github.com/EmbeddedMike/webpack-react-redux)

## New capability
* Incorporates Browser-sync
* Catches Browser-sync messages on websockets for possible improvements
* Does server hot reloading (not well. Planned improvements)
